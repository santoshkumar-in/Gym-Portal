        ...
        <table className="w-full table-auto">
          ...
          <tbody>
            {services.map((service) => (
              <tr key={service.serviceMappingId} className="border-b border-[#eee] dark:border-strokedark">
                <td className="px-4 py-5 text-black dark:text-white">{service.serviceName}</td>
