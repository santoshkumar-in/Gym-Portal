...
const settings = {
  ...
  slidesToScroll: 1,
  arrows: false,
  className: "service-package-slick-slider",
};
          ...
          <div className="px-4 pb-6 text-center lg:pb-8 xl:pb-11.5">
            ...
            <div className="relative mt-4">
              ...
              <div className="mx-auto mt-2 max-w-180">
                ...
                <p className="mt-4.5">
                  Elevate your fitness journey with our all-in-one gym offering
                  a wide range of services, including strength training, cardio,
                  yoga, personal training, group classes, and more. Whether
                  you&apos;re a beginner or a pro, our expert trainers and
                  state-of-the-art equipment are here to help you achieve your
